...
const dbopen = sqlite.open({ filename: './data/twitter.db', driver: sqlite3.Database });
...
exports.addTweet = async function (twitterID, tweetID) {
    ...
    let statement = await db.run(SQL`INSERT OR IGNORE INTO tweets (twitterID, tweetID) VALUES (${twitterID}, ${tweetID})`);
    return statement.changes;
}
